...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Faculty","Humanities","Management","Education")
        dep_combo.current(0)
        ...
        #label Course
        cou_label=Label(current_course_frame,text="Program",font=("verdana",12,"bold"),bg="white",fg="navyblue")
        ...
        cou_combo["values"]=("Select Program","BCA","BBS","B.Ed")
        cou_combo.current(0)
